...
class IndividualProtectorNavigator @Inject() () extends Navigator {
  ...
  private def simpleNavigation(mode: Mode): PartialFunction[Page, UserAnswers => Call] = {
    ...
    case PassportDetailsPage | IdCardDetailsPage | PassportOrIdCardDetailsPage =>
      _ => rts.MentalCapacityYesNoController.onPageLoad(mode)
    ...
    case CountryOfNationalityYesNoPage    =>
      ua =>
        yesNoNav(
          ...
          navigateAwayFromCountryOfNationalityQuestions(mode, ua)
        )
    ...
    case PassportOrIdCardDetailsYesNoPage =>
      ua =>
        yesNoNav(
          ...
          rts.PassportOrIdCardDetailsController.onPageLoad(),
          rts.MentalCapacityYesNoController.onPageLoad(mode)
        )
  }
