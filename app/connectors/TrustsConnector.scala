...
class TrustsConnector @Inject() (http: HttpClientV2, config: FrontendAppConfig) {
  ...
  def addIndividualProtector(identifier: String, protector: IndividualProtector)(implicit
    hc: HeaderCarrier,
    ec: ExecutionContext
  ): Future[HttpResponse] = {
  ...
  def amendIndividualProtector(identifier: String, index: Int, individual: IndividualProtector)(implicit
    hc: HeaderCarrier,
    ec: ExecutionContext
  ): Future[HttpResponse] = {
  ...
  def addBusinessProtector(identifier: String, protector: BusinessProtector)(implicit
    hc: HeaderCarrier,
    ec: ExecutionContext
  ): Future[HttpResponse] = {
  ...
  def amendBusinessProtector(identifier: String, index: Int, protector: BusinessProtector)(implicit
    hc: HeaderCarrier,
    ec: ExecutionContext
  ): Future[HttpResponse] = {
