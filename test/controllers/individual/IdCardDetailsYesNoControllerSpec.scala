...
class IdCardDetailsYesNoControllerSpec extends SpecBase with MockitoSugar {
  ...
  private def form: Form[Boolean] = formProvider.withPrefix("individualProtector.idCardDetailsYesNo")
  ...
  private val idCardDetailsYesNoRoute: String = routes.IdCardDetailsYesNoController.onPageLoad(mode).url
